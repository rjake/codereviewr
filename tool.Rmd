...
parse_it <- function(get_line){
    ...
    #main funciton        
        ...
        get_type <- 
            ...
            eval(parse(text = file_details$creation[get_line]), envir =  .GlobalEnv)
